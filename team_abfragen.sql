...
SELECT KUNDE.NACHNAME, BESTELLUNG.BESTELLNR, REZEPT.BEZEICHNUNG
FROM REZEPT
RIGHT JOIN REZEPTBESTELL ON REZEPTBESTELL.REZEPTNR = REZEPT.REZEPTNR
RIGHT JOIN BESTELLUNG ON BESTELLUNG.BESTELLNR = REZEPTBESTELL.BESTELLNR
RIGHT JOIN KUNDE ON BESTELLUNG.KUNDENNR = KUNDE.KUNDENNR
;
...
LEFT JOIN REZEPTBESTELL ON REZEPTBESTELL.BESTELLNR = BESTELLUNG.BESTELLNR
LEFT JOIN REZEPT ON REZEPT.REZEPTNR = REZEPTBESTELL.REZEPTNR
;